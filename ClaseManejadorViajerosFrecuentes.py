...
class ManejadorViajerosFrecuentes:
    ...
    def listarViajeros(self):
        ...
        for unViajero in self.__viajeros:
            if isinstance(unViajero, ViajeroFrecuente):
                print("{0:<10}{1:<9}{2:<15}{3:<15}{4}".format(unViajero.getNumero(), unViajero.getDNI(), unViajero.getNombre(), unViajero.getApellido(), unViajero.getmilla()))
    ...
    def consultarCantidadMillas(self):
        ...
        if indice != -1:
            ...
            print("No se encuentra el viajero")
    ...
    def mostrarViajerosMayorCantidadDeMillasAcumuladas(self):
        ...
        for otroViajero in self.__viajeros:
            if unViajero == otroViajero:
                print("{0:^8}{1:^11}{2:^15}{3:^15}{4:^8}".format(otroViajero.getNumero(), otroViajero.getDNI(), otroViajero.getNombre(), otroViajero.getApellido(), otroViajero.getmilla()))